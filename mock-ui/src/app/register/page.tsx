...
import { registerWithEmail, getOAuthRedirectUrl } from '@/apis/auth.page.api'
...
export default function RegisterPage() {
  ...
  const handleEmailRegister = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setError(formatErrorResponse(err) || 'Registration failed. Please try again.')
      console.error(err)
    } finally {
      setLoading(false)
    }
  ...
  const handleOAuthLogin = async (provider: 'google' | 'facebook') => {
    ...
    try {
      ...
      setError(formatErrorResponse(err) || `An error occurred with ${provider} signup.`)
      console.error(err)
    } finally {
